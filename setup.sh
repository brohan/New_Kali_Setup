...
apt-get -y install openvas tor hexchat hostapd-wpe kde-spectacle synaptic libpq-dev bridge-utils libnl-3-dev libgcrypt11-dev libnl-genl-3-dev devscripts
